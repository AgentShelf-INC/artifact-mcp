...
const RESERVED = new Set(["mcp", "health", "settings", "favicon.ico", "robots.txt", ""]);

const insert = db.prepare(`
  INSERT INTO artifacts (id, client_id, org, title, description, bytes)
  VALUES (@id, @client_id, @org, @title, @description, @bytes)
`);
...
export function publish({ clientId, org, html, title, description }) {
