...
<div class="wrap">
  <header class="masthead">
    ...
    <div class="whoami">${viewer.isAdmin ? '<a class="ln" href="/settings">Settings</a>' : ""}<span>signed in</span><span class="badge">${esc(viewer.email)} · <span class="role">${role}</span></span></div>
  </header>
  <div class="toolbar">
