...
<body>
  ...
  <script>
    (function(){
      ...
      function fbOpen(open){fbPanel.classList.toggle('open',open);fbPanel.setAttribute('aria-hidden',open?'false':'true');fbToggle.setAttribute('aria-expanded',open?'true':'false');if(open){setTimeout(function(){fbBody.focus();},180);}}
